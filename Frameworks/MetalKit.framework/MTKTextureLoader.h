...
- (void)newAsyncTextureWithNames:(id)arg1 scaleFactor:(double)arg2 displayGamut:(unsigned long long)arg3 bundle:(id)arg4 options:(id)arg5 completionHandler:(id /* block */)arg6;
...
- (void)newTextureWithName:(id)arg1 scaleFactor:(double)arg2 displayGamut:(unsigned long long)arg3 bundle:(id)arg4 options:(id)arg5 completionHandler:(id /* block */)arg6;
- (id)newTextureWithName:(id)arg1 scaleFactor:(double)arg2 displayGamut:(unsigned long long)arg3 bundle:(id)arg4 options:(id)arg5 error:(id*)arg6;
...
- (void)newTexturesWithNames:(id)arg1 scaleFactor:(double)arg2 displayGamut:(unsigned long long)arg3 bundle:(id)arg4 options:(id)arg5 completionHandler:(id /* block */)arg6;
