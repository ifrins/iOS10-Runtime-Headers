...
- (id)initWithDevice:(id)arg1 srcAlpha:(unsigned long long)arg2 destAlpha:(unsigned long long)arg3 backgroundColor:(double*)arg4 colorConverter:(const struct CGColorConversionInfo { }*)arg5;
